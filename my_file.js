...
app.get("/users", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    res.json({ data: users, meta: { length: users === null || users === void 0 ? void 0 : users.length } });
}));
...
app.post("/users", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const users = yield addUser(userTest.username, userTest.firstname, userTest.lastname, userTest.age);
    res.json(users);
}));
app.patch("/users/:userid", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const updateUser = yield updateFirstnameLastname(updateUserId.userid, updateUserTest.username, updateUserTest.firstname, updateUserTest.lastname, updateUserTest.age);
...
app.get("/users", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    res.json({
        ...
        meta: {
            page: page,
            length: getResultLimit === null || getResultLimit === void 0 ? void 0 : getResultLimit.length,
...
function getUserName() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const res = yield pool.query('select "firstname","lastname" from "users"');
            console.log("✅ Connected! Result:", res.rows);
            return res.rows;
        }
        catch (err) {
...
function addUser(username, firstname, lastname, age) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const res = yield pool.query(`insert into "users" (username, firstname, lastname ,age) values ('${username}','${firstname}','${lastname}','${age}')`);
            console.log("✅ Connected! Result:", res.rows);
            return res.rows;
        }
        catch (err) {
...
function updateFirstnameLastname(userid, username, firstname, lastname, age) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const res = yield pool.query(`update "users" set ${arrayvalue.toString()} where userid = '${userid}';`);
            console.log("✅ Connected! Result:", res.rows);
            return res.rows;
        }
        catch (err) {
...
function deleteUserId(userid) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const res = yield pool.query(`DELETE FROM "users"  WHERE userid ='${userid}'`);
            console.log("✅ Connected! Result:", res.rows);
            return res.rows;
        }
        catch (err) {
...
function getUserId(userid) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const res = yield pool.query(`SELECT * FROM "users" WHERE userid = '${userid}';`);
            console.log("✅ Connected! Result:", res.rows);
            return res.rows;
        }
        catch (err) {
...
function getLimitUser(limit, offset) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const res = yield pool.query(`SELECT * FROM users limit ${limit} offset ${offset} ;`);
            console.log("✅ Connected! Result:", res.rows);
            return res.rows;
        }
        catch (err) {
...
app.post("/product", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const productAdd = yield addProduct(productCreatTest.productname, productCreatTest.price, productCreatTest.createddate, productCreatTest.createdby);
    res.json(productAdd);
}));
...
function addProduct(productname, price, createddate, createdby) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const res = yield pool.query(`insert into product (productname, price, createddate ,createdby) values ('${productname}','${price}','${createddate}','${createdby}')`);
            console.log("✅ Connected! Result:", res.rows);
            return res.rows;
        }
        catch (err) {
...
function getLimitProduct(limit, offset) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const res = yield pool.query(`SELECT * FROM product limit ${limit} offset ${offset} ;`);
            console.log("✅ Connected! Result:", res.rows);
            return res.rows;
        }
        catch (err) {
